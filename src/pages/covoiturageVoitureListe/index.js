...
import CovoitureSearchPanel from "../../components/searchBar/covoitureSearchPanel";
import CovoitureListCard from "../../components/cards/covoitureListCard";
import CovoiturageFilterPanel from "../../components/searchBar/covoiturageFilterPanel";
...
const CovoiturageListe = () => {
    ...
    return <Container fluid  style={{margin: "2em 0 5em 0", width: "100%", padding:"0 1.5em"}}>
    <CovoitureSearchPanel />
    <Container fluid className="text-muted pt-4" style={{height: "40px"}}>
        <span>Résultats 1 - 20</span>
    </Container>
    <Row>
        <Col sm="4">
            <CovoiturageFilterPanel />
        </Col>
        <Col sm="8">
            <Row className="mb-5">
                {
                    list.map((item) => <Col sm="12" className="mt-4">
                        <CovoitureListCard post={item} idProp={Proprietaire[0].id} />
                    </Col> )
                }
            </Row>
...
export default CovoiturageListe;